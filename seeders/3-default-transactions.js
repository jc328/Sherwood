...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Transactions', [
      { price: 207, share_quantity: 50, stock_id: 3619, user_id: 1, createdAt: new Date(), updatedAt: new Date()},
      ...
      { price: 1497, share_quantity: 100, stock_id: 2214, user_id: 1, createdAt: new Date(), updatedAt: new Date()},
